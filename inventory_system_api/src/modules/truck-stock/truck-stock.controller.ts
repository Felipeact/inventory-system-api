...
export class TruckStockController extends BaseController {
    ...
    uploadReceiptFile = asyncHandler(async (req: AuthRequest, res: Response) => {
        const data = await this.service.uploadReceiptFile(
            req.body,
            req.user!.companyId,
            req.user!.userId
        );
    ...
    extractReceipt = asyncHandler(async (req: AuthRequest, res: Response) => {
        const data = await this.service.extractReceipt(
            req.body,
            req.user!.companyId,
            req.user!.userId
        );
