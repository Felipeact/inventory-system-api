...
export const metadata: Metadata = {
  ...
  description:
    "Get a personalized 30-minute demo of StockPilot set up for your trade and fleet. See real-time inventory and truck-stock management in action.",
};
      ...
      <div className="container-page grid items-start gap-12 lg:grid-cols-2">
        ...
        <div>
          ...
          <h1 className="mt-3 text-balance text-4xl font-extrabold tracking-tight text-ink-900 sm:text-5xl">
            See StockPilot running on trucks like yours
          </h1>
          <p className="mt-5 max-w-xl text-lg text-ink-600">
            No slideshow. A product specialist sets up StockPilot with sample data for your
